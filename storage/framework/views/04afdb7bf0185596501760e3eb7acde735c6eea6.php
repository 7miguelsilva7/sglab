			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li class="treeview"><a href="<?php echo e(url('/users')); ?>"><i class="fa fa-users"></i> <span>Users</span></a></li>
						<li class="treeview"><a href="<?php echo e(url('/roles')); ?>"><i class="fa fa-user-plus"></i> <span>Role</span></a></li>
						<li class="treeview"><a href="<?php echo e(url('/permissions')); ?>"><i class="fa fa-key"></i> <span>Permissions</span></a></li>
					</ul>
				</section>
				<!-- /.sidebar -->
			</aside>
