...
<html lang="en">
    ...
    <body>
                ...
                <div class="col s7">
                    ...
                    <div>
                        ...
                        <table class = 'centered highlight'>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $scaffold; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                        ...
                        <span>Scaffold-interface <span class = 'scaffoldv blue white-text'>v1.6.12</span></span><br><br>
        ...
        <div class="fixed-action-btn horizontal click-to-toggle" style="bottom: 45px; right: 24px;">
            ...
            <ul>
                <li><a href = "<?php echo e(URL::to('/')); ?>/dashboard" class="btn-floating blue tooltipped" data-position="left" data-delay="50" data-tooltip="Dashboard"><i class="material-icons">view_list</i></a></li>
                ...
                <li><a href = "<?php echo e(URL::to('/')); ?>/scaffold/migrate" class="btn-floating orange tooltipped" data-position="left" data-delay="50" data-tooltip="Migrate the Schema"><i class="material-icons">input</i></a></li>
            </ul>
        </div>
