...
<html lang="en">
    ...
    <body>
        <div class = 'container'>
            ...
            <br>
            <form method = 'POST' action = '<?php echo e($names->open()); ?>url("<?php echo e($names->standardApi()); ?>")<?php echo e($names->close()); ?>/<?php echo e($names->open()); ?>$<?php echo e($names->TableNameSingle()); ?>->id<?php echo e($names->close()); ?>/update'>
