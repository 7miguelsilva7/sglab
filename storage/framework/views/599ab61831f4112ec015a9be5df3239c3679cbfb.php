...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <br>
            <form method = 'POST' action = '<?php echo e(url("escola")); ?>'>
...
<select class="form-control" name="tipo_internet_escola" id="select11" required>
                ...
                <div class="col-md-6">   
                    ...
                    <select name = 'pessoa_id' style="no" class = 'form-control' id="select3" required>
                        ...
                        <?php $__currentLoopData = $pessoas->except($pessoas->id=2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <option value="<?php echo e($key); ?>"><?php echo e($value); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                    </select>
                </div>
