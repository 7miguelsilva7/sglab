...
<?php echo Form::open(['method'=>'GET','url'=>'pessoa','class'=>'navbar-form navbar-right','role'=>'search']); ?>


<?php
                        $usuario_logado = Auth::user()->name;
                        if ($usuario_logado == "Admin") { ?>
<a href="<?php echo e(url('pessoa/create')); ?>" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Novo</a>
<?php } ?>
