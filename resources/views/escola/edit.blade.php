...
<hr>                
                ...
                <div class="col-md-6">
                    ...
                    <input required id="inep" name = "inep" type="number" value="{{$escola->inep}}" class="form-control">
                </div>
                ...
                <label for="bairro">Bairro</label>
                    <input required id="bairro" name = "bairro" type="text" value="{{$escola->bairro}}" class="form-control">
                </div>
                </div>
                </div>
                </div>
